...
- **Initiatives en faveur de la diffusion de savoir-faire et de connaissances** (RZine, écoles thématiques, supports, tutoriels, etc.)
...
Mise en œuvre **des bonnes pratiques de développement logiciel** (*versioning*, tests, documentation, etc.)
...
- Implication dans des réseaux métiers (MATE-SHS, MAGIS, etc.), semaines DATA-SHS, etc.
...
- **Principaux dev. open source du RIATE** - [https://github.com/riatelab](https://github.com/riatelab)
- Matthieu Viry - [matthieu.viry@cnrs.fr](mailto:matthieu.viry@cnrs.fr)

<small>Présentation disponible sur <a href="https://riatecom.github.io/jjc-magis-2025/" target="_blank">https://riatecom.github.io/jjc-magis-2025/</a></small>
